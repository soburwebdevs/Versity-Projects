...
// Fetch all sellers to populate the dropdown
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO product (s_id, p_name, p_price, p_category, p_model) 
            VALUES ('$s_id', '$p_name', '$p_price', '$p_category', '$p_model')";
...
<body>
    ...
    <form method="POST">
        ...
        <select name="s_id" required>
            ...
            if ($sellerResult->num_rows > 0) {
                while ($seller = $sellerResult->fetch_assoc()) {
                    echo "<option value='" . $seller["s_id"] . "'>" . $seller["s_id"] . " - " . $seller["s_name"] . "</option>";
                }
            }
            ?>
        </select>
        ...
        <input type="text" name="p_model" required>
